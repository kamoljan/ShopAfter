...
import org.kamol.shopafter.data.DataModule;
import org.kamol.shopafter.ui.gallery.ListingView;
...
public class AndroidModule {
  private final ShopAfterApp application;

  public AndroidModule(ShopAfterApp application) {
